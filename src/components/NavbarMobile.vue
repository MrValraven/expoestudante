<template>
  <nav>
    ...
    <ul v-if="isActive" class="navLinks" :class="isActive">
      <li class="navlink">
        <svg
          id="Flat"
          :height="iconSize"
        ...
        <router-link to="/" @click="toggleClass()">Início</router-link>
      </li>
      <li class="dropdown" @click="openSobre = !openSobre">
        ...
        <a class="navLink"
          >Sobre
          <i class="fas fa-chevron-down" :class="{ activated: openSobre }"></i
        ></a>
        <div class="subMenu" v-if="openSobre">
          <router-link to="/sobre/porque" @click="toggleClass()">
            Porquê?</router-link
          >
          <router-link to="/sobre/onde" @click="toggleClass()">
            Onde?</router-link
          >
        </div>
      </li>
      <li class="navlink">
        ...
        <router-link to="/contactos" @click="toggleClass()">
...
export default defineComponent({
  ...
  methods: {
    toggleClass() {
      ...
      this.activatedNavbar
        ? (this.whiteSvg = "#FFFFFF")
        : (this.whiteSvg = "#8690FA");
      this.activatedNavbar
        ? (this.darkerWhiteSvg = "#FFFFFF")
        : (this.darkerWhiteSvg = "#5153ff");
